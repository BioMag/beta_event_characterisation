"""
Calculate and plot intra class correlation of rate between two sessions 
"""
import pandas as pd
import mne
import numpy as np
...
# Collect the ICC values from each parcel and rate values from the pre-central parcel
...
for sensor in range(0,len(lh_parc)):
    ...
    for low_high in ["low", "high"]:
        # Make empty list for rate values
