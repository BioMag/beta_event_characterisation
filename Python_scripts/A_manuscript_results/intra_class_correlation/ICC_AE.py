"""
Calculate and plot intra class correlation of EA between two sessions 
"""
import pandas as pd
import mne
import numpy as np
...
# Collect the ICC values from each parcel and EA values from the pre-central parcel
        ...
        for ses in [1,2]:
            for i,row in df_subjects.iterrows():
                ...
                subject_df = EA_feature_df.loc[
                    ...
                    EA_feature_df['session']==ses].loc[
                    EA_feature_df['measure']=='mean'].loc[
                    EA_feature_df['perc']==75]
                sens_values = subject_df[sens_id].values[0]
...
x_lims = [(5e-11,9e-10),(5e-11,7e-10)]
